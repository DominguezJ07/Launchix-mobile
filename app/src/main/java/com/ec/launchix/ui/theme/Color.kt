...
val Gray900 = Color(0xFF212121)              // Texto principal

// Colores de sistema
val SuccessGreen = Color(0xFF4CAF50)         // Verde éxito
val WarningOrange = Color(0xFFFF9800)        // Naranja advertencia
val ErrorRed = LaunchixRed                   // Rojo error (mismo que marca)
val InfoBlue = Color(0xFFE53E3E)             // Azul información

// Colores base
val SurfaceWhite = Color(0xFFFFFFFF)         // Blanco puro
val SurfaceLight = Gray50                    // Gris clarísimo
val Black = Color(0xFF000000)                // Negro puro